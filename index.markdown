...
# Education
I am currently pursueing a PhD in Mathematics in Paris, jointly at the [Centre de Mathématiques Appliquées](https://cmap.ip-paris.fr/) (CMAP), École Polytechnique and [Laboratoire Mathématiques d'Orsay](https://www.imo.universite-paris-saclay.fr/en/) (LMO), Paris-Saclay. Together with  [Michael Goldman](http://www.cmap.polytechnique.fr/~michael.goldman/) (CMAP) and [Cyril Letrouit](https://www.imo.universite-paris-saclay.fr/~cyril.letrouit/index.html) (LMO), we are working on better understaind the quantitative stability properties of the optimal transport problem. This is crucial for applications - to quantify errors introduced by approximations - as well from a theoretical viewpoint - to better understand the behaviour of the optimal transport problem under deformations of its marginals.
